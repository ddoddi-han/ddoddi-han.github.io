window.resumeTranslations = window.resumeTranslations || {};

window.resumeTranslations.ja = {
  meta: {
    title: "ハン・ソルジ | フルスタックエンジニア",
    description:
      "ハン・ソルジ - 効率よく働くために手を動かすフルスタックエンジニア",
    ogTitle: "ハン・ソルジ | フルスタックエンジニア",
    ogDescription:
      "React・Next.js・Node.jsを用いたOT/ICS・VoIPセキュリティ製品のWebコンソール開発",
  },
  profileAlt: "ハン・ソルジのプロフィール写真",
  name: "ハン・ソルジ",
  timelineSrc: "./assets/career-timeline-ja.svg",
  timelineAlt:
    "XTD v1からXTD v3、DPS、SMR、VIPER、DDへ続くキャリアタイムライン",
  languageLabel: "言語",
  contactLabel: "連絡先",
  companyName: "NAONWORKS.",
  emailLabel: "メール:",
  blogLabel: "ブログ:",
  githubLabel: "GitHub:",
  lead:
  ...
  viperWork1:
    "<strong>共通モジュールの標準化</strong><br />FE・BE共通モジュールをShared Packageに集約し、重複コードと修正時のオーバーヘッドを削減しました。",
  viperWork2:
    "<strong>セキュリティ基盤の構築</strong><br />CC認証要件に基づき、JWTベースのログイン、IP・権限検証、アカウントロック、監査ログなどの必須セキュリティ機能を実装しました。",
  viperWork3:
    "<strong>レスポンシブUI/UX</strong><br />デスクトップ・モバイル向けのレスポンシブUI/UXを自ら設計・デザインし、開発全般を担当しました。",
  smrProduct: "小型モジュール炉向けセキュリティ監視ソリューション",
  smrDescription:
  ...
  ddDescription:
    "未経験のVue・Kotlinを用いるプロジェクトに短期間で参画し、既存コードベースを迅速に把握して要件を完遂しました。",
  ddWork1:
  ...
  playwrightWork1:
    "<strong>Web性能測定</strong><br />主要画面のURLに対するレスポンス性能を繰り返し測定し、Navigation Timing APIの指標をExcelレポートにまとめました。",
  playwrightWork2:
    "<strong>BVT E2E自動化</strong><br />アカウント・通知・運用ログ・システム設定など12の主要機能をPlaywrightのE2Eシナリオとして作成し、ビルドごとに同一条件で検証できるようにしました。",
  footer: "最終更新: 2026.08",
};
